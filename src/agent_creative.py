...
4. 2번째 카드뉴스 내용부터 중간 페이지들('content' 타입)은 핵심 정보를 구조화해서 정리해줘 (예: "1. 핵심기능명 🧠\n상세 정보 내용과 구체적인 예시"). 이때, 설명 단위마다 기사 본문의 맥락과 내용에 딱 들어맞는 직관적이고 다채로운 이모티콘(이모지, 예: https://emojipedia.org/ 에 수재된 🧠, 👁️, ✍️, 🎨, 🤖, 🚀, 🔥, 💡 등)을 2개 이상 풍부하게 섞어 넣어 가독성과 재미를 극대화해줘. 절대 텍스트만 밋밋하게 나열되지 않게 해줘!
